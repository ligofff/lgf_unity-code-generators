...
1. Make an [Issue](https://github.com/ligofff/lgf_unity-code-generators/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf_unity-code-generators": "https://github.com/YOUR_USER/lgf_unity-code-generators.git"
        }
    }
```
